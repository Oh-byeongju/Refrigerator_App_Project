...
public class Recommend_recipe {
    ...
    public ArrayList<String> Return_recipe(ArrayList<String> p_name){
        if((p_name.contains("김치") && p_name.contains("고기") && p_name.contains("대파"))){
            f_name.add("김치찌개");
        }
        if((p_name.contains("김치") && p_name.contains("양파") && p_name.contains("햄"))){
            f_name.add("김치볶음밥");
        }
        if((p_name.contains("오이") && p_name.contains("고추") && p_name.contains("양파"))){
            f_name.add("오이무침");
        }
        if((p_name.contains("고기") && p_name.contains("양파") && p_name.contains("대파") && p_name.contains("당근"))){
            f_name.add("두루치기");
        }
        ...
        if((p_name.contains("두부") && p_name.contains("파") && p_name.contains("양파"))) {
            f_name.add("두부조림");
        }
